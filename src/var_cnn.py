...
from keras.layers import Conv1D, MaxPooling1D, Dense, Activation, ZeroPadding1D, \
    GlobalAveragePooling1D, Add, Concatenate, Dropout, BatchNormalization
...
def get_model(config, mixture_num):
    ...
    model_checkpoint = ModelCheckpoint('model_weights.weights.h5', monitor='val_accuracy',
                                       save_best_only=True,
